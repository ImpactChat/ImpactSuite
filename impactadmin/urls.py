...
from .views import AdministrationAdvancedView, AdministrationDetailView, AdministrationView, DashboardView, DownloadModelsView, LoginView, LogoutView, ProfileView
